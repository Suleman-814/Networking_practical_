...
A collection of **Cisco Packet Tracer (.pkt)** lab files covering essential networking concepts and practical assignments. This repository is designed for students, beginners, and anyone preparing for networking practical exams or the CCNA certification.
...
##  Included Packet Tracer Files

- `dhcp&telnet assignment.pkt`
- `inter vlan routing assignment (s).pkt`
- `ip basic assignment (cnsole)11.pkt`
- `port security assignment.pkt`
- `practice ipv6.pkt`
- `rip command assignment.pkt`
...
- Networking students
- CCNA beginners
- Practice networking configurations
